...
def test_tzolkin_signs_are_immutable_tuple():
    assert isinstance(TZOLKIN_DAY_SIGNS, tuple)
...
def test_haab_months_are_immutable_tuple():
    assert isinstance(HAAB_MONTHS, tuple)
