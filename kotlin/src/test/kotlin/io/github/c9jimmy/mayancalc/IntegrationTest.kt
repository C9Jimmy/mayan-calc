...
class IntegrationTest {
    ...
    inner class Maya2012 {
        ...
        @Test fun longCount()        = assertEquals("13.0.0.0.0", result.longCount.display)
    ...
    inner class Y2K {
        ...
        @Test fun longCount()        = assertEquals("12.19.6.15.2", result.longCount.display)
    ...
    inner class Frankie {
        ...
        @Test fun longCount()        = assertEquals("12.18.15.11.0", result.longCount.display)
    ...
    inner class Today {
        ...
        @Test fun longCount()        = assertEquals("13.0.13.10.13", result.longCount.display)
